...
$webOS   = stripos($_SERVER['HTTP_USER_AGENT'],"webOS");
      ...
      $sql = $db->query("SELECT * FROM apple WHERE Category = 'divertido' ORDER BY id DESC LIMIT $start, $limit"); 
      $directory = 'apple/';
    } else {    
      $sql = $db->query("SELECT * FROM images WHERE Category = 'divertido' ORDER BY id DESC LIMIT $start, $limit");
      $directory = 'uploads/';
    }
