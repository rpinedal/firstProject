...
$insert1 = "INSERT INTO crating_info (user_id, comment_id, rating_action) VALUES ('".$uID."', '".$commentID."','like')";
...
$rating = mysqli_real_escape_string($db,$row['rating_action']);
 ...
 if ($rating == "like") {
  ...
  <p class="likeError">Necesita Iniciar Sesion para dar Me Gusta.</p>
<?php 
} ?>
