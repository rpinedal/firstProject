...
include 'Menu/indexMenu.php'; 
        ...
        $perfilQuery = "SELECT * FROM users WHERE BINARY user_id = '".$linkmd."'";
        ...
        $queryPuntos = "SELECT SUM(like_num) AS SCORE FROM images WHERE uploader_id = $id";
            ...
            $userID = $id = mysqli_real_escape_string($db, $processQuery['user_id']);
...
<?php } ?> 
  ...
  <div class="" style="border-left: 1px solid grey; padding-left: 10px; margin-left: 12px;">

      <h1 style="font-size: 25px;"><strong class="postedby"><?php echo $name ?></strong></h1>
