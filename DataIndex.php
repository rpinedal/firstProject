...
$webOS   = stripos($_SERVER['HTTP_USER_AGENT'],"webOS");
      ...
      $sql = $db->query("SELECT * FROM apple WHERE like_num > 120 ORDER BY id DESC LIMIT $random, $limit"); 
      $directory = 'apple/';
    } else {    
      $sql = $db->query("SELECT * FROM images WHERE like_num > 120 ORDER BY id DESC LIMIT $random, $limit");
      $directory = 'uploads/';
    }
